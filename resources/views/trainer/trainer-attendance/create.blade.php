        ...
        <div class="card shadow-sm border-0">
            ...
            <div class="card-header" style="background: linear-gradient(135deg, #0d2818 0%, #1a472a 100%); color: white;">
                <div class="d-flex justify-content-between align-items-center flex-wrap">
                    <h4 class="mb-0">
                        <i class="fas fa-user-check me-2"></i> Mark My Attendance
                    </h4>
                    <a href="{{ route('trainer.trainer-attendance.index') }}" 
                       class="btn" 
            ...
            <div class="card-body">
                ...
                <form method="POST" action="{{ route('trainer.trainer-attendance.store') }}">
                    @csrf
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        // Auto-fill current time when clicking check-in field
        ...
        // Auto-fill current time when clicking check-out field
