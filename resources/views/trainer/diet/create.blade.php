        ...
        <div class="card shadow-sm border-0">
            ...
            <div class="card-header" style="background: linear-gradient(135deg, #0d2818 0%, #1a472a 100%); color: white;">
                <div class="d-flex justify-content-between align-items-center flex-wrap">
                    <h4 class="mb-0">
                        <i class="fas fa-plus-circle me-2"></i> Add Diet Plan
                    </h4>
            ...
            <div class="card-body">
                ...
                <form action="{{ route('trainer.diet.store') }}" method="POST">
                    @csrf
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group mb-3">
                                <label class="form-label fw-bold">
                                    <i class="fas fa-users me-1" style="color: #1a472a;"></i> Select Members <span class="text-danger">*</span>
                                </label>
                                <div class="border rounded p-3" style="height:250px; overflow-y:auto; border-color: #1a472a !important;">
                                    @foreach ($members as $member)
                                        <div class="form-check mb-3">
                                            <input type="checkbox" class="form-check-input" id="member{{ $member->id }}"
                                            ...
                                            <label class="form-check-label w-100" for="member{{ $member->id }}">
                                                ...
                                                @if ($member->plan_type == 'membership')
                                                    <span class="badge" style="background: #0d2818; color: #ffd54f;">Membership</span>
                                                @else
                                                    <span class="badge" style="background: #ffd54f; color: #0d2818;">Package</span>
                                                @endif
                                                <span class="badge" style="background: #1a472a; color: white;">{{ $member->membership_plan }}</span>
                                            </label>
                                        </div>
                                    @endforeach
                                </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group mb-3">
                                ...
                                <input type="text" name="title" class="form-control" style="border-color: #1a472a; border-radius: 8px;" placeholder="Enter diet title" required>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="date" name="start_date" class="form-control" style="border-color: #1a472a; border-radius: 8px;" required>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="date" name="end_date" class="form-control" style="border-color: #1a472a; border-radius: 8px;">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group mb-3">
                                ...
                                <textarea name="description" rows="3" class="form-control" style="border-color: #1a472a; border-radius: 8px;" placeholder="Enter diet description..."></textarea>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="card-header" style="background: #f8fafc; border-bottom-color: #1a472a;">
                                <div class="d-flex justify-content-between align-items-center">
                                    <span style="color: #0d2818;">
                                        <span class="badge" style="background: #0d2818; color: white;">#1</span>
                            ...
                            <div class="card-body">
                                <div class="row mb-3">
                                    <div class="col-md-6">
                                        ...
                                        <select name="meals[0][day]" class="form-control meal-day" style="border-color: #1a472a; border-radius: 8px;" required>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <select name="meals[0][meal_time]" class="form-control meal-time" style="border-color: #1a472a; border-radius: 8px;" required>
                                ...
                                <div class="food-items-container border rounded p-3" style="border-color: #1a472a !important;">
                                    ...
                                    <div class="food-item-row row mb-2 align-items-center">
                                        <div class="col-md-3 mb-2">
                                            <input type="text" class="form-control" style="border-color: #1a472a; border-radius: 8px;" name="meals[0][food_items][0][food_name]" placeholder="Food Name *" required>
                                        </div>
                                        <div class="col-md-2 mb-2">
                                            <input type="text" class="form-control" style="border-color: #1a472a; border-radius: 8px;" name="meals[0][food_items][0][quantity]" placeholder="Qty">
                                        </div>
                                        <div class="col-md-2 mb-2">
                                            <input type="text" class="form-control" style="border-color: #1a472a; border-radius: 8px;" name="meals[0][food_items][0][calories]" placeholder="Calories">
                                        </div>
                                        <div class="col-md-1 mb-2">
                                            <input type="text" class="form-control" style="border-color: #1a472a; border-radius: 8px;" name="meals[0][food_items][0][protein]" placeholder="Protein">
                                        </div>
                                        <div class="col-md-1 mb-2">
                                            <input type="text" class="form-control" style="border-color: #1a472a; border-radius: 8px;" name="meals[0][food_items][0][carbs]" placeholder="Carbs">
                                        </div>
                                        <div class="col-md-1 mb-2">
                                            <input type="text" class="form-control" style="border-color: #1a472a; border-radius: 8px;" name="meals[0][food_items][0][fats]" placeholder="Fats">
                                        </div>
                                        <div class="col-md-1 mb-2">
                                            <input type="text" class="form-control" style="border-color: #1a472a; border-radius: 8px;" name="meals[0][food_items][0][notes]" placeholder="Notes">
                                        </div>
                    ...
                    <div class="mt-3 text-center">
                        <button type="submit" class="btn" style="background: #0d2818; color: white; border-radius: 8px; padding: 10px 30px;">
                            <i class="fas fa-save me-2"></i> Save Diet Plan
                        </button>
