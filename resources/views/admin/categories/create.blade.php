    ...
    <div class="form-card">
        <div class="card-header">
            <div>
                ...
                <small style="opacity:0.8;">Create a new category for your products</small>
            </div>
            ...
            <form action="{{ route('admin.categories.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <select name="top_category_id" class="form-control @error('top_category_id') is-invalid @enderror" required>
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <small class="text-muted">Enable to make this category active and visible</small>
                    </div>
                </div>
