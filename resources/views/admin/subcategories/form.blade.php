...
<div class="admin-main-content">
    <div class="form-card">
        <div class="card-header">
            <div>
                <h4><i class="fas fa-{{ isset($subCategory) ? 'edit' : 'plus' }}"></i> {{ isset($subCategory) ? 'Edit Sub Category' : 'Add Sub Category' }}</h4>
                <small style="opacity:0.8;">{{ isset($subCategory) ? 'Update sub category details' : 'Create a new sub category' }}</small>
            </div>
            <span style="background:rgba(74,158,255,0.2); color:#8ab4f8; padding:3px 12px; border-radius:50px; font-size:11px;">
                <i class="fas fa-circle" style="font-size:6px; color:#4caf50;"></i> {{ isset($subCategory) ? 'Edit Mode' : 'Create Mode' }}
            </span>
        </div>
        ...
        <div class="card-body">
            ...
            <form action="{{ isset($subCategory) ? route('admin.subcategories.update', $subCategory->id) : route('admin.subcategories.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="section-title">
                    <i class="fas fa-info-circle"></i> Sub Category Details
                </div>
                    ...
                    <div class="col-md-6 mb-3">
                        <div class="form-check" style="margin-top: 28px;">
                            <input class="form-check-input" type="checkbox" name="is_active" value="1" 
                                   id="is_active" {{ old('is_active', $subCategory->is_active ?? 1) ? 'checked' : '' }}>
                            <label class="form-check-label" for="is_active">
                                <i class="fas fa-circle" style="font-size:8px; color:#4caf50;"></i> Active
                            </label>
                        </div>
                        <small class="text-muted" style="font-size:11px;">Enable to make this sub category active and visible</small>
                    </div>
                </div>
                ...
                <div class="form-actions">
                    <button type="submit" class="btn btn-primary">
                        <i class="fas fa-save"></i> {{ isset($subCategory) ? 'Update' : 'Save' }}
                    </button>
