    ...
    <div class="admin-main-content">
        <div class="create-card">
            <div class="card-header">
                <div>
                    <h4><i class="fas fa-box"></i> Create Package</h4>
                ...
                <form action="{{ route('admin.package.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row compact-row">
                        ...
                        <div class="col-md-3 mb-3">
                            ...
                            <input type="number" name="duration" class="form-control" value="{{ old('duration', 1) }}"
                                min="1" required>
                        </div>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <select name="duration_type" class="form-control" required>
                                ...
                                <option value="Months" {{ old('duration_type') == 'Months' ? 'selected' : '' }} selected>
                                    Months</option>
                    ...
                    <div class="row compact-row">
                        <div class="col-md-12 mb-3">
                            <label class="form-label">Included Features <small class="text-muted">(One per
                                    line)</small></label>
                            <textarea name="included_features" class="form-control" rows="4"
