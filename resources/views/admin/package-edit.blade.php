...
@section('content')
    <style>
        ...
        .image-preview-container .preview-img.hidden {
            display: none;
        }
    ...
    <div class="admin-main-content">
        <div class="edit-card">
            <div class="card-header">
                <div>
                    <h4><i class="fas fa-edit"></i> Edit Package</h4>
                    <small>Update package details</small>
                </div>
            ...
            <div class="card-body">
                ...
                <form action="{{ route('admin.package.update', $package->id) }}" method="POST"
                    ...
                    <div class="section-title">
                        <i class="fas fa-info-circle"></i> Package Information
                    </div>
                    ...
                    <div class="row compact-row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <select name="duration_type" class="form-control" required>
                                <option value="Days"
                                    {{ old('duration_type', $package->duration_type) == 'Days' ? 'selected' : '' }}>Days
                                </option>
                                <option value="Months"
                                    {{ old('duration_type', $package->duration_type) == 'Months' ? 'selected' : '' }}>Months
                                </option>
                                <option value="Years"
                                    {{ old('duration_type', $package->duration_type) == 'Years' ? 'selected' : '' }}>Years
                                </option>
                            </select>
                        </div>
                    </div>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <select name="status" class="form-control" required>
                                ...
                                <option value="Inactive"
                                    {{ old('status', $package->status) == 'Inactive' ? 'selected' : '' }}>Inactive</option>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="row compact-row">
                        <div class="col-md-12 mb-3">
                            <label class="form-label">Included Features <small class="text-muted">(One per
                                    line)</small></label>
                            <textarea name="included_features" class="form-control" rows="4">{{ old('included_features', $package->included_features) }}</textarea>
                            <small class="text-muted" style="font-size:10px;"><i class="fas fa-info-circle"></i> Each
                                feature on a new line</small>
                        </div>
                    </div>
