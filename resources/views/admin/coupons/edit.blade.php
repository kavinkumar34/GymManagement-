    ...
    <div class="admin-main-content">
        <div class="edit-card">
            <div class="card-header">
                <div>
                    <h4><i class="fas fa-edit"></i> Edit Coupon</h4>
                    <small>Update coupon: <strong style="color:#8ab4f8;">{{ $coupon->code }}</strong></small>
                </div>
            ...
            <div class="card-body">
                @if ($errors->any())
                    <div class="alert alert-danger"
                        style="background:#fce4ec; color:#c62828; border-left:4px solid #ef5350; border-radius:var(--radius); padding:12px 18px; margin-bottom:16px; border:none;">
                ...
                <form action="{{ route('admin.coupons.update', $coupon->id) }}" method="POST">
                    ...
                    <div class="row compact-row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <small class="text-muted-sm">Will be automatically converted to uppercase</small>
                            @error('code')
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" name="name" class="form-control"
                                value="{{ old('name', $coupon->name) }}" placeholder="e.g., 10% Off First Order">
                            @error('name')
                                <div class="text-danger" style="font-size:12px; margin-top:4px;">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="row compact-row">
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="number" step="0.01" name="min_order_amount" class="form-control"
                                value="{{ old('min_order_amount', $coupon->min_order_amount ?? 0) }}" placeholder="0">
                    ...
                    <div class="row compact-row">
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <span class="used-count"><i class="fas fa-check-circle text-success"></i> Used:
                                {{ $coupon->used_count }} times</span>
                            @error('usage_limit')
                                <div class="text-danger" style="font-size:12px; margin-top:4px;">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="number" name="per_user_limit" class="form-control"
                                value="{{ old('per_user_limit', $coupon->per_user_limit ?? 1) }}" placeholder="1">
