    ...
    <div class="form-card">
        <div class="card-header">
            <div>
                ...
                <small>Create a new product with variants</small>
            </div>
            <span style="background:rgba(74,158,255,0.2); color:#8ab4f8; padding:3px 12px; border-radius:50px; font-size:11px;">
                <i class="fas fa-circle" style="font-size:6px; color:#4caf50;"></i> Create Mode
            </span>
        </div>
            ...
            <form method="POST" action="{{ route('admin.products.store') }}" enctype="multipart/form-data" id="productForm">
                ...
                <div class="row">
                    <div class="col-md-4 mb-3">
                        ...
                        <div class="help-text" id="gst_selected_info"><i class="fas fa-info-circle"></i> Select to auto-fill GST</div>
                    </div>
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <div class="help-text" id="subCategoryHelper"><i class="fas fa-info-circle"></i> Select category first</div>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <div class="help-text" id="productTypeHelper"><i class="fas fa-info-circle"></i> Select category first</div>
                    </div>
                </div>
                    ...
                    <div class="col-12 mb-3">
                        ...
                        <select name="size_chart_id" id="size_chart_id" class="form-control">
                            ...
                            @foreach ($sizeCharts ?? [] as $sc)
                                <option value="{{ $sc->id }}" data-gender="{{ $sc->gender ?? 'unisex' }}" data-category="{{ $sc->category_type ?? 'topwear' }}">
                                    {{ $sc->title }}
                ...
                <div class="card mb-3" id="pricingSection">
                    <div class="card-body">
                        ...
                        <div class="gst-info" id="gst_info_box" style="display:none;">
                            ...
                            <span class="gst-value" id="gst_rate_display">0%</span>
                            <span class="gst-label"><i class="fas fa-calculator"></i> GST Amount:</span>
                            <span class="gst-value" id="gst_amount_display">₹0.00</span>
                            <span style="color: var(--gray); font-size: 12px;">(Calculated on SP)</span>
                        </div>

                        <!-- Calculation Flow -->
                        <div class="calculation-flow" id="calculation_flow">
                            <span class="step">SP: <span class="highlight" id="flow_selling">₹0</span></span>
                            <span class="arrow">+</span>
                            <span class="step">GST: <span class="highlight" id="flow_gst">₹0</span></span>
                            <span class="arrow">=</span>
                            <span class="step">Total: <span class="highlight" id="flow_total_price">₹0</span></span>
                            <span class="arrow">−</span>
                            <span class="step">Disc: <span class="highlight" id="flow_discount">₹0</span></span>
                            <span class="arrow">=</span>
                            <span class="step" style="border-color: var(--success); background: #e8f5e9;">Final: <span class="highlight green" id="flow_final">₹0</span></span>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-3 mb-3">
                                ...
                                <div class="price-input-group">
                                    ...
                                    <input type="number" step="0.01" name="price" id="price" class="form-control" required min="0" value="0">
                                </div>
                        ...
                        <div class="row">
                            <div class="col-md-3 mb-3">
                                ...
                                <div class="price-input-group">
                                    <span class="currency-symbol">₹</span>
                                    <input type="number" step="0.01" id="gst_amount_field" class="form-control" readonly style="background: var(--light-gray); font-weight: 600; color: var(--primary);">
                                </div>
                            </div>
                            ...
                            <div class="col-md-3 mb-3">
                                ...
                                <div class="price-input-group">
                                    <span class="currency-symbol">₹</span>
                                    <input type="number" step="0.01" id="discount_amount_display" class="form-control" readonly style="background: #fce4ec; font-weight: 600; color: var(--danger);">
                                </div>
                            </div>
                            ...
                            <div class="col-md-3 mb-3">
                                ...
                                <div class="price-input-group">
                                    <span class="currency-symbol">₹</span>
                                    <input type="number" step="0.01" name="final_price" id="final_price" class="form-control" readonly style="background: #e8f5e9; font-weight: 700; color: var(--success); font-size: 17px; border-color: #a5d6a7;">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row mt-3">
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <div class="d-flex align-items-center mt-2" style="gap:10px;">
                                    ...
                                    <span class="toggle-label">Status: <span id="cod_status" class="toggle-status active">Available</span></span>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="variant-section" id="variantSection">
                    <div class="section-title">
                        ...
                        <span class="text-muted" style="font-size:11px; font-weight:400; color:var(--gray);" id="variantTypeLabel">Top Wear</span>
                        <span class="badge" id="variantGstBadge" style="background:var(--primary); color:#fff; font-size:9px;">GST: 0%</span>
                    </div>
                            ...
                            <div class="variant-item" id="variant-default">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <input type="text" name="variants[default][color]" class="form-control variant-required" placeholder="e.g., Red, Blue, Black">
                                        <div class="help-text"><i class="fas fa-pencil-alt"></i> Enter color name manually</div>
                                    </div>

                                    <div class="col-md-8 mb-3">
                                        <label class="field-label">Images <span class="required-star">*</span> <span class="text-muted" style="font-size:11px; color:var(--gray);">(Multiple allowed)</span></label>
                                        ...
                                        <input type="file" id="variant_images_input_default" name="variants[default][images][]" class="form-control mt-1" accept="image/*" multiple style="display:none;" onchange="previewVariantImages(this, 'default')">
                                        <div id="variant_images_preview_default" class="variant-image-preview-container"></div>
                                    </div>
                                </div>
                                    ...
                                    <div id="sizesContainer_default" class="sizes-container">
                                        <div class="size-row">
                                            <div class="form-group">
                                                <label>Size</label>
                                                <input type="text" name="variants[default][sizes][0][size]" class="form-control variant-required" placeholder="S, M, L, XL">
                                            </div>
                                            <div class="form-group">
                                                <label>Cost Price</label>
                                                <input type="number" step="0.01" name="variants[default][sizes][0][cost_price]" class="form-control" placeholder="0" min="0" oninput="calculateSizePrice(this, 'default', 0)">
                                            </div>
                                            <div class="form-group">
                                                <label>MRP</label>
                                                <input type="number" step="0.01" name="variants[default][sizes][0][mrp]" class="form-control variant-required" placeholder="0" min="0" oninput="calculateSizePrice(this, 'default', 0)">
                                            </div>
                                            <div class="form-group" style="min-width:55px;">
                                                <label>Stock</label>
                                                <input type="number" name="variants[default][sizes][0][stock]" class="form-control variant-stock" placeholder="0" min="0" oninput="updateAllStocks()" onchange="updateAllStocks()">
                                            </div>
                                            <div class="form-group" style="min-width:65px;">
                                                <label>Disc Type</label>
                                                <select name="variants[default][sizes][0][discount_type]" class="form-control" onchange="calculateSizePrice(this, 'default', 0)">
                                            ...
                                            <div class="form-group" style="min-width:60px;">
                                                ...
                                                <input type="number" step="0.01" name="variants[default][sizes][0][discount_value]" class="form-control" placeholder="0" min="0" oninput="calculateSizePrice(this, 'default', 0)">
                                            </div>
                ...
                <div class="card mb-3">
                    <div class="card-body">
                        <div class="mb-3">
                            ...
                            <textarea name="description" id="description" class="form-control" rows="5" placeholder="Enter product description with bullet points..."></textarea>
                        ...
                        <div class="mt-3" id="descriptionPreview" style="display:none;">
                            ...
                            <div class="border rounded p-3 bg-light" id="descriptionPreviewContent" style="font-size:13px; border:1px solid var(--border-color) !important;"></div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card mb-3" id="productImagesSection">
                    <div class="card-body">
                        <div class="mb-3">
                            <label class="field-label">Images <span class="required-star">*</span> <span class="text-muted" style="font-weight:400; font-size:11px; color:var(--gray);">(1-4)</span></label>
                            <div class="image-upload-area" onclick="document.getElementById('product_images_input').click()">
                                <i class="fas fa-cloud-upload-alt"></i>
                                <p>Click to upload images</p>
                            </div>
                            <input type="file" id="product_images_input" name="images[]" class="form-control mt-1" accept="image/*" multiple style="display:block;" onchange="previewImages(this)">
...
<script>
    $(document).ready(function() {
            ...
            variantImageFiles[variantId].forEach(function(file, index) {
                ...
                reader.onload = function(e) {
                    preview.append(
                        ...
                        '<button type="button" class="remove-img" onclick="removeVariantImage(\'' + variantId +
                        '\', ' + index + ')">×</button>' +
                        '</div>'
                    );
                };
        ...
        $('#category').on('change', function() {
            ...
            productTypeSelect.empty().append('<option value="">-- Select --</option>');
                    ...
                    success: function(data) {
                        if (data.length > 0) {
                            $.each(data, function(i, pt) {
                                productTypeSelect.append('<option value="' + pt.id + '">' + pt
                                    .name + '</option>');
                            });
                        }
                    }
    ...
    $('#discount_value_hint').text('Enter percentage discount (%)');
        ...
        window.previewImages = function(input) {
            var files = Array.from(input.files);
            var totalFiles = imageFiles.length + files.length;
            ...
            imageFiles.forEach(function(file, index) {
                ...
                reader.onload = function(e) {
                    preview.append(
                        ...
                        '" style="font-size:9px; width:100%; text-align:center; display:block; padding:1px 0; margin-top:2px;">' +
                        (index === 0 ? 'Main' : 'Image ' + (index + 1)) + '</span>' +
                        '</div>'
                    );
                };
                reader.readAsDataURL(file);
        ...
        $('#productForm').on('submit', function(e) {
            if (isVariantMode) {
                ...
                for (var key in variantImageFiles) {
                ...
                for (var key in variantImageFiles) {
                    if (variantImageFiles[key] && variantImageFiles[key].length > 0) {
                        ...
                        if (input) {
                            var dataTransfer = new DataTransfer();
                            variantImageFiles[key].forEach(function(file) {
            ...
            // Product images (only for normal mode)
            if (!isVariantMode && imageFiles.length === 0) {
                e.preventDefault();
