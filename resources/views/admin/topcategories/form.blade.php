...
<div class="admin-main-content">
    <div class="form-card">
        <div class="card-header">
            <div>
                <h4><i class="fas fa-{{ isset($topCategory) ? 'edit' : 'plus' }}"></i> {{ isset($topCategory) ? 'Edit Top Category' : 'Add New Top Category' }}</h4>
                <small style="opacity:0.8;">{{ isset($topCategory) ? 'Update category details' : 'Create a new top category' }}</small>
            </div>
            <span style="background:rgba(74,158,255,0.2); color:#8ab4f8; padding:3px 12px; border-radius:50px; font-size:11px;">
                <i class="fas fa-circle" style="font-size:6px; color:#4caf50;"></i> {{ isset($topCategory) ? 'Edit Mode' : 'Create Mode' }}
            </span>
        </div>
            ...
            <form action="{{ isset($topCategory) ? route('admin.topcategories.update', $topCategory->id) : route('admin.topcategories.store') }}" method="POST">
                ...
                <div class="row">
                    <div class="col-12 mb-3">
                        ...
                        <textarea name="description" class="form-control" rows="3" placeholder="Enter category description">{{ old('description', $topCategory->description ?? '') }}</textarea>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-12 mb-3">
                        ...
                        <small class="text-muted" style="font-size:11px;">Enable to make this category active and visible</small>
                    </div>
                </div>
                ...
                <div class="form-actions">
                    <button type="submit" class="btn btn-primary">
                        <i class="fas fa-save"></i> {{ isset($topCategory) ? 'Update' : 'Save' }}
                    </button>
                    <a href="{{ route('admin.topcategories.index') }}" class="btn btn-secondary">
...
document.addEventListener('DOMContentLoaded', function() {
    // Auto-hide any success/error messages after 3 seconds
