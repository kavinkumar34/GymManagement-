...
@section('content')
    <style>
        ...
        .table-attendance .member-name {
            font-weight: 600;
            color: var(--dark);
        }

        .table-attendance .member-email {
            font-size: 11px;
            color: var(--gray);
            display: block;
        }
        ...
        .table-attendance .trainer-name i {
            color: var(--primary);
            margin-right: 4px;
        }
    ...
    <div class="admin-main-content">
        <div class="attendance-card">
            ...
            <div class="card-header">
                <div>
                    <h4><i class="fas fa-clipboard-check"></i> Member Attendance</h4>
                    <small style="opacity:0.8;">Manage member attendance records</small>
                </div>
                <span
            ...
            <div class="card-body">
                ...
                <div class="search-filter-section">
                    <div class="search-box">
                        ...
                        <input type="text" id="searchInput" placeholder="Search by member name, email, trainer..."
                            onkeyup="filterTable()">
                    </div>
                            ...
                            @forelse($attendance as $index => $row)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <span class="member-email">{{ $row->member->email ?? '-' }}</span>
                                    </td>
                                    <td>
                                        @if ($row->trainer)
                                            <span class="trainer-name"><i class="fas fa-chalkboard-user"></i>
                                                {{ $row->trainer->name ?? '-' }}</span>
                                        @else
                                            <span class="text-muted" style="font-size:11px;">Not Assigned</span>
                                        @endif
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    <td colspan="8">
                                        <div class="empty-state">
                                            ...
                                            <p>No member attendance records available.</p>
                                        </div>
                                    </td>
                                </tr>
                            @endforelse
    ...
    <script>
        ...
        function filterTable() {
            ...
            rows.forEach(function(row) {
                ...
                var date = row.querySelector('td:nth-child(4)')?.textContent.trim() || '';
