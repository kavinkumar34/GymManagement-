...
@section('content')
    ...
    <script>
        ...
        function handleAddToCartShop(product) {
            ...
            if (colorContainer) {
                if (sortedColors.length === 0) {
                    ...
                    const colorMap = {
                        ...
                        'grey': '#808080', 'gray': '#808080', 'navy': '#000080',
                            ...
                            <div class="card-body">
                                ...
                                <div class="product-action-buttons">
                                    ...
                                    <button class="btn-add-cart-home" 
                                        onclick="event.stopPropagation(); handleAddToCartShop(${JSON.stringify(productDataForModal).replace(/"/g, '&quot;')})"
                                        ${!isInStock ? 'disabled' : ''}>
